...
def create_dataset(folder, file: str = "training.csv", n: int = 50, height: int = 200, width: int = 300,
                   n_circles: int = 10, min_r: int = 15, max_r: int = 20, prefix="train", n_classes=3):
    boxes = []
    for i in range(n):
